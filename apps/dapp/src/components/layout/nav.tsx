  ...
  return (
    <nav className="flex justify-between items-center mb-8 fixed top-0 left-0 right-0 z-10 px-2 sm:px-6 h-20 border-b-2 border-brand bg-white dark:bg-gray-900">
      ...
      <div className="flex items-center sm:space-x-2">
        <button id="mm-widget-btn" className={isDark ? "w-full p-3 border border-white text-white hover:bg-white/10 rounded-full" : "w-full p-3 border border-black text-black hover:bg-black/10 rounded-full"}>Connect Wallet</button>
        <Button
